...
class test_obj(test_base):
	def __init__(self):
		...
		db['kernel_type'] = 'multiquadratic'					# rbf, polynomial, mkl, squared, multiquadratic
...
#prog.collect_10_fold_info(prog.db['W_optimize_technique'])
#prog.collect_10_fold_info(grassman)
prog.basic_run()
#prog.batch_run()
